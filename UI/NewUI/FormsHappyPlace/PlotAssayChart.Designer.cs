namespace NewUI
{
    partial class PlotAssayChart
    {
        ...
        private void InitializeComponent()
        {
			...
			title1.Name = "Title1";
			title1.Text = "Calib curve, Calib data points, Verification data points (legend)";
			...
			title2.Name = "Title2";
			title2.Text = "Multiplication Corrected Doubles Rate";
			...
			title3.Name = "Title3";
			title3.Text = "Pu240 Effective Mass";
